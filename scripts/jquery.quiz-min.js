    ...
    (o.methods = {
        ...
        o.options.counter && (i += '<div id="quiz-counter"></div>'),
          ...
          z.each(s, function (t, e) {
            (i += '<div class="question-container">'),
              (i += '<p class="question">' + e.q + "</p>"),
              (i += '<ul class="answers">'),
              z.each(e.options, function (t, e) {
                i +=
                  '<li><a href="#" data-index="' + t + '">' + e + "</a></li>";
              }),
              (i += "</ul>"),
              (i += "</div>");
          }),
          ...
          o.$el
            .append((i += "</div>"))
            .addClass("quiz-container quiz-start-state"),
          z("#quiz-counter").hide(),
          z(".question-container").hide(),
          z(c).hide(),
          z(a).hide(),
          z("#quiz-controls").hide(),
          "function" == typeof o.options.setupCallback &&
      ...
      start: function () {
        o.$el.removeClass("quiz-start-state").addClass("quiz-questions-state"),
          ...
          z("#questions").hide(),
          z("#quiz-counter").show(),
          z(".question-container:first-child")
            .show()
            .addClass("active-question"),
          z("#active-question").show(),
      ...
      answerQuestion: function (t) {
        if (!f) {
          ...
          var e = z(t),
            ...
            n = e.data("index"),
            t = q - 1;
          if (n === s[t].correctIndex)
            e.addClass("correct"), (i = s[t].correctResponse), p++;
          else if (
            (e.addClass("incorrect"),
            (i = s[t].incorrectResponse),
            !o.options.allowIncorrect)
          )
            return void o.methods.gameOver(i);
          z("#quiz-response").html(i),
            z("#quiz-controls").fadeIn(),
            "function" == typeof o.options.answerCallback &&
      ...
      nextQuestion: function () {
        (f = !1),
          ...
          z("#quiz-controls").hide(),
          ++q === i &&
            (z("#quiz-next-btn").hide(), z("#quiz-finish-btn").show()),
          o.methods.updateCounter(),
          "function" == typeof o.options.nextCallback &&
            o.options.nextCallback();
      ...
      gameOver: function (t) {
        ...
        (0 === z(c).length) &
          ((e = ""),
          (e += '<div id="' + c.substr(1) + '">'),
          (e += '<p id="quiz-gameover-response"></p>'),
          (e += '<p><a href="#" id="quiz-retry-btn">' + h + "</a></p>"),
          o.$el.append((e += "</div>"))),
      ...
      finish: function () {
        o.$el
          ...
          z(a).show();
        var t = o.options.resultsFormat
          .replace("%score", p)
          .replace("%total", i);
        z("#quiz-results").html(t),
          "function" == typeof o.options.finishCallback &&
            o.options.finishCallback();
      },
      restart: function () {
        o.methods.reset(),
          o.$el.addClass("quiz-questions-state"),
          z("#questions").hide(),
          z("#quiz-counter").show(),
          z(".question-container:first-child")
            .show()
      ...
      reset: function () {
        (f = !1),
          ...
          z("#quiz-counter").hide(),
          z(".active-question").hide().removeClass("active-question"),
          "function" == typeof o.options.resetCallback &&
            o.options.resetCallback();
      },
      home: function () {
        o.methods.reset(),
          o.$el.addClass("quiz-start-state"),
          z(n).show(),
          "function" == typeof o.options.homeCallback &&
            o.options.homeCallback();
      },
      updateCounter: function () {
        var t = o.options.counterFormat
          .replace("%current", q)
          .replace("%total", i);
